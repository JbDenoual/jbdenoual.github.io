  ...
  <div class="product-management screen">
    <div class="pm_global_1">
      <div class="pm_section_1">
        <div class="header-6">
          <div class="header-7">
            <router-link to="/index-1"><img class="logo-5" :src="logo" alt="Logo" /></router-link>
            <div class="menu-3">
              <router-link to="/index-1">
                <div class="link-3 rubik-normal-white-16px">{{ accueil1 }}</div>
              </router-link>
        ...
        <div class="pm_section_1_details">
          ...
          ></h1>
          <p class="surname-5 rubik-light-white-22px">{{ surname1 }}</p>
          <router-link to="/contact">
            ...
            <div class="overlap-group-20">
              ...
              <div class="pm_section_3_1">
                ...
                <div class="pm_section_3_1_2">
                  ...
                  <p class="surname-6 rubik-light-shark-32px">{{ surname2 }}</p>
                </div>
          ...
          ><a href="files/Pratiquer la phase de Discovery.pdf" target="_blank">
            <div class="pm_section_4_offer">
              <div class="overlap-group-17">
                ...
                <pm-b1 :className="pmB11Props.className" />
              </div></div></a
          ><a href="files/Pratiquer la phase de Delivery.pdf" target="_blank">
            <div class="pm_section_4_offer">
              <div class="overlap-group-17">
                ...
                <pm-b1 :className="pmB12Props.className" />
              </div></div
          ></a>
        </div>
      </div>
      <footer class="footer-3">
        ...
        <div class="footer_links-3">
          <div class="footer_links_1-3">
            <router-link to="/index-1"><img class="logo-5" :src="logo_2" alt="logo_2" /></router-link>
            <div class="menu-3">
              <router-link to="/index-1">
                <div class="link-3 rubik-normal-white-16px">{{ accueil2 }}</div>
              </router-link>
              <div class="product-management-1 rubik-normal-white-16px">{{ productManagement2 }}</div>
              <router-link to="/product-ops">
                <div class="link-3 rubik-normal-white-16px">{{ productOps2 }}</div> </router-link
              ><router-link to="/experiences">
